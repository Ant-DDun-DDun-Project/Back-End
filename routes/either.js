...
router.get('/:either_id/target', getTargetEither); // 찬반투표 특정페이지 뷰
...
router.post('/:either_id/votes', voteEither); // 찬반 투표
router.patch('/:either_id/complete', completeEither); // 찬반 투표 종료
