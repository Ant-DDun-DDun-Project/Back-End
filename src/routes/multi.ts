...
router.post('/:multi_id/childComment/:comment_id/likes', auth, childCommentControllers.likeChildComment); // 대댓글 좋아요
router.patch('/:multi_id/childComment/:comment_id/edit', auth, childCommentControllers.editChildComment); // 대댓글 수정
router.patch('/:multi_id/childComment/:comment_id/delete', auth, childCommentControllers.deleteChildComment); // 대댓글 삭제
